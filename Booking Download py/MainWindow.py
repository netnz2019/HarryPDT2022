...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "nights"))
        self.label_12.setText(_translate("MainWindow", "pric"))
                ...
                if val.value == self.comboBox.currentText():
                    ...
                    if room != "":
                        if len(room) > 8:
                            ...
                            ws.cell(row=val.row, column=10).value = room

                    if price != "":
                        if int(price) > 10000:
                            self.lineEdit.setPlaceholderText("To Rich")
                            self.lineEdit.setText("")
                        else:
                    ...
                    if phone != "":
                        if len(phone) > 15 or len(phone) < 4:
                            self.lineEdit.setPlaceholderText("Invalid Number")
                            self.lineEdit.setText("")
                        else:
                            ws.cell(row=val.row, column=12).value = int(phone)
